...
image:https://git.vshn.net/vshn/handbook-style/badges/develop/pipeline.svg[link="https://git.vshn.net/vshn/handbook-style/commits/develop",title="pipeline status"]
