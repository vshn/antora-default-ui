= VSHN Antora UI Default

// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/vshn/antora-ui-default
...
This project contains the default UI of the VSHN Handbook. It is based in the "Default UI" project of the {url-antora}[Antora] project.
...
ui:
  bundle:
    url: https://github.com/vshn/antora-ui-default/-/jobs/artifacts/master/raw/build/ui-bundle.zip?job=bundle-stable
    snapshot: true
----
